...
extern idt AddPersona( idt refID, idt indID, const wxString& nameStr, int* pseq );
...
extern idt CreateRefPersona( Sex sex, idt refID, idt indID, const wxString& nameStr, int* pseq );
extern idt CreateRefPersona( Sex sex, idt refID, idt indID, idt nameID );
